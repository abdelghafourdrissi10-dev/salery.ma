          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch mb-20">
              ...
              <PricingCard
                ...
                title={t.enterprise}
                badge={lang === 'ar' ? 'باقة المؤسسات' : lang === 'fr' ? 'Entreprise Plus' : 'Enterprise Plus'}
                price={convert(billingCycle === 'monthly' ? prices.monthly.enterprise : prices.yearly.enterprise)}
                cycle={billingCycle === 'monthly' ? t.mo : t.yr}
                symbol={symbols[currency]}
                limit={t.unlimited}
