...
import { 
  ShieldCheck, Landmark, BarChart4, Cpu, Network, 
  BadgeCheck, ShieldAlert, Fingerprint, FileCheck, 
  ArrowUpRight, Globe, Lock, Activity, Server, Database,
  ArrowRight, CheckCircle2, AlertTriangle, RefreshCw,
  FileDown, FileSignature, FileStack, Archive, Search, History
} from 'lucide-react';
import { 
                 ...
                 <div className="relative z-10 space-y-10">
                    ...
                    <div className="pt-8 border-t border-gray-100 flex items-center justify-between">
                       <div className="flex items-center gap-3">
                          <Fingerprint size={20} className="text-gray-300" />
