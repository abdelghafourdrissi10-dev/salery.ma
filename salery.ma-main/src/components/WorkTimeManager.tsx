...
const WorkTimeManager: React.FC<Props> = ({ employees, lang, user }) => {
  ...
  const t = {
    fr: {
      title: "Work Time Template Engine",
             ...
             <div key={tpl.id} className="airbnb-card p-8 bg-white border-[#E5E7EB] hover:border-[#0078D4] transition-all group flex flex-col justify-between">
                <div className="space-y-6">
                   ...
                   <div className="text-start">
                      ...
                      <p className="text-[10px] font-black uppercase text-gray-400 tracking-widest mt-1">{tpl.sector.replace('_', ' ')}</p>
                   </div>

                   <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-gray-50 rounded-xl">
                         <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Base Hebdo</p>
                         <p className="text-lg font-black text-[#1A1F36]">{tpl.weeklyHours}h</p>
                      </div>
                      <div className="p-3 bg-gray-50 rounded-xl">
                         <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Jour / Sem</p>
                         <p className="text-lg font-black text-[#1A1F36]">{tpl.daysPerWeek}j</p>
                      </div>
                      <div className="p-3 bg-blue-50 rounded-xl">
                         <p className="text-[8px] font-black text-blue-400 uppercase tracking-widest">Quotidien</p>
                         <p className="text-lg font-black text-[#0078D4]">{tpl.dailyHours}h</p>
                      </div>
                      <div className="p-3 bg-blue-50 rounded-xl">
                         <p className="text-[8px] font-black text-blue-400 uppercase tracking-widest">Réf Mensuelle</p>
  ...
  <div className="flex items-center justify-between p-4 bg-[#F9FAFB] rounded-2xl group hover:bg-white transition-all border border-transparent hover:border-blue-100">
     <div className="flex items-center gap-4 text-start">
        <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${
          level === 'HIGH' ? 'bg-rose-50 border-rose-100 text-rose-500' : 
