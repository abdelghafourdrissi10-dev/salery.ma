    ...
    <div id="pro-document" className="bg-white p-12 w-[210mm] min-h-[297mm] mx-auto font-sans text-[#1C1C1C] relative border-t-8 border-[#0052FF]" dir={isAr ? 'rtl' : 'ltr'}>
      <header className="flex justify-between items-start mb-10 pb-8 border-b border-gray-100">
        ...
        <div className="w-1/2 flex justify-end">
           <div className="bg-[#1A1F36] px-8 py-4 rounded-[24px] shadow-xl flex flex-col items-end relative overflow-hidden">
              <h1 className="relative z-10 text-xl font-black tracking-tight flex items-center gap-3 m-0 p-0">
                 <span className="text-white">BULLETIN DE PAIE</span>
                 <span className="text-zinc-500">|</span>
                 <span className="font-arabic text-lg text-white">ورقة الأداء</span>
              </h1>
              <p className="relative z-10 text-[11px] font-bold text-[#3B82F6] uppercase mt-1 tracking-widest m-0 p-0">
      ...
      <div className="flex justify-between items-center mb-16 px-4">
         ...
         <div className="relative">
            ...
            <div className="relative bg-[#1A1F36] p-8 rounded-[40px] shadow-2xl min-w-[340px] flex flex-col items-end border-4 border-white overflow-hidden">
               <p className="relative z-10 text-[11px] font-black uppercase tracking-[0.3em] text-[#60A5FA] mb-2 m-0 p-0">{labels.net.fr} / <span className="font-arabic">{labels.net.ar}</span></p>
               <div className="relative z-10 flex items-baseline justify-end gap-3 m-0 p-0">
                  <h2 className="text-5xl font-black tracking-tighter text-white">{payroll.netSalary.toLocaleString('fr-MA', { minimumFractionDigits: 2 })}</h2>
                  <span className="text-xl font-black text-[#60A5FA]">DH</span>
               </div>
            </div>
         </div>
      </div>
      ...
      <footer className="grid grid-cols-2 gap-16 mt-auto pt-10 border-t border-[#E3E8EE]">
        ...
        <div className="text-right flex flex-col justify-between">
           <div>
              ...
              <p className="text-[9px] text-gray-500 font-medium italic">Lu et Approuvé / قرئ وصودق عليه</p>
           </div>
